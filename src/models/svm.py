...
def main():
    ...
    plot_confusion_matrix(y_test, y_pred, labels=pipeline.named_steps["svm"].classes_, output_dir=current_runs_dir, model_name='SVM')
    plot_feature_importance(pipeline, feature_names, output_dir=current_runs_dir, top_n=10, model_name='SVM')
